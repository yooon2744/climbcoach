    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
          ...
          <button className="social-btn social-kakao" onClick={() => signInWithSocial("kakao")}>
            <KakaoIcon />
            카카오로 시작하기
          </button>
        </div>
...
function KakaoIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24">
      <path fill="#3C1E1E" d="M12 3C6.48 3 2 6.48 2 10.8c0 2.7 1.6 5.07 4 6.53L5 21l3.8-2.53c1.02.27 2.1.43 3.2.43 5.52 0 10-3.48 10-7.8S17.52 3 12 3z"/>
    </svg>
  );
}
